...
public class InvocationCount_priority_both {
	//Used both invocationCount and priority.
	@Test(invocationCount = 2,priority = 2)
	public void Launch_Google_RightClick_Gmail() throws InterruptedException
	{
